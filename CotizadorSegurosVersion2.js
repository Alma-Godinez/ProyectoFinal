alert ("Bienvenido al cotizador Seguros TKU")
...
var num_propiedades = 0.35;// 35%

var salario_1 = 0.05;// 5%
...
//Verificamos la cantidad de propiedades del asegurado
var cantidad_propiedad
if("SI" == propiedades.toUpperCase()) {
  cantidad_propiedad = prompt("¿Cuantas propiedades tiene, especifique en números?")
}
var salario = prompt("Porfavor, indicar cual es su salario en números")
//Usuario ingresa su salario
 ...
 */ if (propiedades){
  recargo = precio_base * cantidad_propiedad * num_propiedades
  recargo_total = recargo_total + recargo
 }
/**
 * 5. Recargo por sueldo 
 */ if (salario){
  recargo = salario * salario_1
  recargo_total = recargo_total + recargo
 }
